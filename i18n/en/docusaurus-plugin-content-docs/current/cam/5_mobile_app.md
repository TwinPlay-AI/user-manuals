...
1. **Download the app** from your store:
   - **iOS**: [Download from the App Store](https://apps.apple.com/it/app/twinplay-ai-camera-setup/id6752512394)
   ...
   <div style={{display: 'flex', justifyContent: 'center', gap: '40px', margin: '20px 0', flexWrap: 'wrap'}}>
     <div style={{textAlign: 'center'}}>
       <img src="/img/qrcode_app-store.png" alt="App Store QR Code" style={{width: '180px'}} />
       <p><em>iOS · App Store</em></p>
     </div>
     <div style={{textAlign: 'center'}}>
       <img src="/img/qrcode_play-store.png" alt="Play Store QR Code" style={{width: '180px'}} />
